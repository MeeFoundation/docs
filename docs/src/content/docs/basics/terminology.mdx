...
A data container associated with a [connection](#connection). A [context](#context) contains entities that represent the user [subject](#subject) and may, in social contexts, contain other [subjects](#subject). 
