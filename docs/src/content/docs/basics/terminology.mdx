...
A [context](#context) whose associated [subjects](#subject) have an identifier, and a set of [claims](#claim) with values that are stored permanently. 

### Transient Context

A [context](#context) whose associated [subjects](#subject) have an identifier, and a set of [claims](#claim) with values that are stored only transiently. 

### Meta Context

A [context](#context) whose associated [subjects](#subject) have an identifier, and a set of [claims](#claim) without values.  [Claim](#claim) values, when needed, may be fetched from the [app](#app) using the [context's](#context) protocol.
