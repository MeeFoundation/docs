...
---
For latest see: https://hackmd.io/-wm4eExyRSmk2GRVvjlmVA?view
...
The *person* that has installed and uses a *smartwallet* on one or more of their devices (e.g. phone, tablet, laptop, home server, etc.).
...
A *subject* with which the holder interacts. An RP may be another person or a legal entity. 

For example, in a *connection* between the *holder's* *smartwallet* and a typical *app*, the *relying party* is the legal entity that provides the *app*. In the special case that the *app* is another *person's* *smartwallet*, the *relying party* is this other *person*.
