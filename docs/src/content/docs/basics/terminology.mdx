...
A [context](#context) whose contained [subject](#subject) entities are identified by an identifier and a set of [claims](#claim) with values. 
...
The interests and demographics of a Mee [identity agent](#identity-agent) user as generated by [Ad Profile Agent](#ad-profile-agent) and managed by an [ad profile service](#ad-profile-service).
