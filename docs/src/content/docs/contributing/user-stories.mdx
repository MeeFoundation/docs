...
| :------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| **user** | my personal data management app (the Mee Smartwallet) is not dependent on any external administrative authority | I have user-sovereignty                                      |
...
| AS A/AN  | I WANT TO…                                                   | SO THAT…                                                     |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **user** | be able to restore my Mee Smartwallet data from backups in the case of a catastrophic disaster wherein I lose all of my devices (and I loose access to my device backups) | I don't lose all of the personal data that I've already collected and lose the investment I've made in assembling it |
