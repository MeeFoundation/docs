...
| :------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| **user** | my personal data management solution is not dependent on any external administrative authority | I have user-sovereignty                                      |
...
### Privacy and the MDN License

| AS A/AN  | I WANT TO…                                                   | SO THAT…                                                     |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **user** | know that apps/sites adhere to the MDN License               | I have a minimum, baseline level of privacy since  will only collect, store, process and share my information with my explicit consent. |
...
| **user** | know that apps/sites adhere to the MDN License               | my data rights to access, correction and deletion are implemented immediately and automatically via APIs |
...
| **user** | login with Connect-with-Mee to mobile app or mobile Safari | I can access apps/sites on the same mobile device as my local agent |
| **user** | login with SIOP                                            | I can access SIOP-compatible sites on my desktop browser  [whether or not they are Mee-certified] |
| **user** | know if the app/site is Mee-certified                      | trust that the protections of the MDN License are in place   |
...
| AS A/AN  | I WANT TO…                     | SO THAT…                                                     |
| -------- | ------------------------------ | ------------------------------------------------------------ |
| **user** | receive messages from my identity agent | I can respond to requests for information, suggestions, etc. from the identity agent |
| **user** | send and receive messages from other identity agent users | communicate securely with others while relying on as few as possible external administrative authorities (e.g. cloud-based servers) |
...
| AS A/AN  | I WANT TO…                                                   | SO THAT…                                                     |
| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **user** | be able to authenticate myself to the local agent (e.g. using facial recognition on a phone) | so that it recognizes me (and only me) and thus my local agent cannot be accessed by others |
