...
This project that applies the Mee experience to internet advertising. This project includes a front-end component, the Mee Extension, and back-end services including an Interests Service and a Private Ad Network. The company logos in the following diagram below are purely hypothetical/aspirational:
